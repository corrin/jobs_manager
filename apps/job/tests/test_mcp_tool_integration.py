...
class QuotingToolTests(TestCase):
    ...
    def test_get_pricing_with_dimensions(self, mock_get_pricing):
        ...
        result = self.tool.get_pricing_for_material(material_type="steel", dimensions="4x8")
        
        mock_get_pricing.assert_called_once_with(material_type="steel", dimensions="4x8")
    ...
    def test_get_supplier_status(self, mock_get_supplier_info):
        ...
        mock_get_supplier_info.return_value = {
            "suppliers": [
                {"name": "ABC Steel", "last_updated": "2024-01-15", "product_count": 1250},
                {"name": "XYZ Steel", "last_updated": "2024-01-10", "product_count": 890},
            ]
        }
