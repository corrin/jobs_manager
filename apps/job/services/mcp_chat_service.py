...
class MCPChatService:
    ...
    def get_claude_client(self) -> Anthropic:
        ...
        try:
            ...
            return Anthropic(api_key=ai_provider.api_key)
...
Always be helpful, professional, and specific in your responses. When providing pricing or material recommendations, explain your reasoning and mention any relevant supplier information."""
        ...
        return [
            {
                ...
                "input_schema": {
                    ...
                    "properties": {
                        ...
                        "supplier_name": {"type": "string", "description": "Optional supplier name filter"}
                    },
                    "required": ["query"]
                }
            },
            {
                ...
                "input_schema": {
                    ...
                    "properties": {
                        ...
                        "dimensions": {"type": "string", "description": "Optional dimensions specification"}
                    },
            ...
            },
            {
                ...
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "job_id": {"type": "string", "description": "Job ID to create quote for"},
                        "materials": {"type": "string", "description": "Description of materials needed"},
            ...
            },
            {
                ...
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "material_query": {"type": "string", "description": "Material to compare prices for"}
                    },
    ...
    def _execute_mcp_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        ...
        try:
            if tool_name == "search_products":
                ...
                return self.quoting_tool.compare_suppliers(
                    arguments["material_query"]
                )
            else:
    ...
    def generate_ai_response(
        ...
        try:
            ...
            recent_messages = JobQuoteChat.objects.filter(
                job=job
            ...
            for chunk in response:
                if chunk.type == "content_block_start":
                    ...
                    if (content_blocks and 
                        content_blocks[-1]["type"] == "tool_use" and 
                        "input" in content_blocks[-1]):
