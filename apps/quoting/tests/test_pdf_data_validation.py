...
class PDFDataValidationServiceTest(TestCase):
    ...
    def test_check_duplicates_no_existing_supplier(self):
        ...
        products = [
            {"product_name": "New Product", "item_no": "NEW-001"}
        ]
    ...
    def test_check_duplicates_with_existing_products(self):
        ...
        products = [
            {"product_name": "Existing Product", "item_no": "EXIST-001"},  # Duplicate by item_no
            {"product_name": "existing product", "item_no": "DIFF-001"},   # Duplicate by name (case-insensitive)
