...
│   ├── workflow/                   # Central app - base functionality
...
```
app_name/
├── __init__.py                     # Auto-generated - DO NOT EDIT DIRECTLY
├── models/                         # Models split by domain
│   ├── __init__.py                 # Auto-generated - model imports
│   ├── core.py                     # Core domain models
│   ├── costing.py                  # Cost-related models
│   └── audit.py                    # Audit/history models
├── views/                          # Views organized by type
│   ├── __init__.py                 # Auto-generated
│   ├── rest_views.py               # REST API views
│   ├── template_views.py           # Django template-based views
│   └── ajax_views.py               # AJAX-specific views
├── services/                       # Service layer
│   ├── __init__.py                 # Auto-generated
│   ├── business_service.py         # Main business logic
│   ├── integration_service.py      # External integrations
│   └── data_service.py             # Complex data operations
├── serializers/                    # DRF serializers
│   ├── __init__.py                 # Auto-generated
│   ├── api_serializers.py          # Main API serializers
│   └── nested_serializers.py       # Nested/specialized serializers
...
## 🚨 CRITICAL RULE: Auto-generated **init**.py Files 🚨

**NEVER edit **init**.py files directly** – they are auto-generated. Run `python scripts/update_init.py` to regenerate them after adding/removing Python files.

### Example of Auto-generated **init**.py
