...
| `/rest/forms/<str:category>/<uuid:pk>/complete/` | `process_document_viewsets.ProcessDocumentCompleteView` | `jobs:form_complete` | Mark a document as completed (read-only). |
| `/rest/forms/<str:category>/<uuid:pk>/fill/` | `process_document_viewsets.ProcessDocumentFillView` | `jobs:form_fill` | Create a new record from a template. |
...
| `/rest/jobs/<uuid:job_id>/jsa/` | `process_document_viewsets.JSAListView` | `jobs:jsa_list` | List all JSAs for a job. |
| `/rest/jobs/<uuid:job_id>/jsa/generate/` | `process_document_viewsets.JSAGenerateView` | `jobs:jsa_generate` | Generate a new JSA for a job. |
...
| `/rest/procedures/<str:category>/<uuid:pk>/content/` | `process_document_viewsets.ProcessDocumentContentView` | `jobs:procedure_content` | GET/PUT content for a process document stored in Google Docs. |
| `/rest/procedures/safety/generate-sop/` | `process_document_viewsets.SOPGenerateView` | `jobs:sop_generate` | Generate a new Standard Operating Procedure. |
| `/rest/procedures/safety/generate-swp/` | `process_document_viewsets.SWPGenerateView` | `jobs:swp_generate` | Generate a new Safe Work Procedure. |
...
| `/rest/safety-ai/improve-document/` | `process_document_viewsets.AIImproveDocumentView` | `jobs:ai_improve_document` | Improve an entire document using AI. |
| `/rest/safety-ai/improve-section/` | `process_document_viewsets.AIImproveSectionView` | `jobs:ai_improve_section` | Improve a section of text using AI. |
