...
| `/rest/sop/` | `process_document_viewsets.SOPListView` | `jobs:sop_list` | List all Standard Operating Procedures. |
| `/rest/sop/generate/` | `process_document_viewsets.SOPGenerateView` | `jobs:sop_generate` | Generate a new Standard Operating Procedure. |
| `/rest/swp/` | `process_document_viewsets.SWPListView` | `jobs:swp_list` | List all Safe Work Procedures. |
| `/rest/swp/generate/` | `process_document_viewsets.SWPGenerateView` | `jobs:swp_generate` | Generate a new Safe Work Procedure. |
